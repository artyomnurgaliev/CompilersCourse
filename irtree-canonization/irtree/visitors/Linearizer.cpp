...
void IRT::Linearizer::Visit(IRT::JumpConditionalStatement *jump_conditional_statement) {
...
void IRT::Linearizer::Visit(IRT::SeqStatement *seq_statement) {
  ...
  if (first->IsSeq()) {
    auto seq = (SeqStatement *) first;
    tos_value_.statement_ = new SeqStatement(seq->first_statement_,
...
IRT::Statement *IRT::Linearizer::GetTree() {
